...
<body>
            ...
            <c:choose>
                <c:when test="${vooCarrinho.tipoVoo eq 'IDA'}">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <td>
                                <c:forEach var="poltronasEscolhidas" items="${sessionScope.poltronasUsuarioIda}">
                                   | ${poltronasEscolhidas.getIdPoltrona()} |
                                </c:forEach>
                            </td>
                        </c:otherwise>
                    </c:choose>
                ...
                <c:otherwise>
                    <c:choose>
                        ...
                        <c:otherwise>
                            <td>
                                <c:forEach var="poltronasEscolhidas" items="${sessionScope.poltronasUsuarioVolta}">
                                    | ${poltronasEscolhidas.getIdPoltrona()} |
                                </c:forEach>
                            </td>
                        </c:otherwise>
    ...
    <c:if test="${dao.escolhaPoltronasFinalizado(sessionScope.carrinho,sessionScope.poltronasUsuario,sessionScope.numeroAdultos)}">
        <div align="center">
